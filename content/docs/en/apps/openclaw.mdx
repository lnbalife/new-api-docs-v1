...
description: OpenClaw tutorial — install OpenClaw via npm, configure it with New API, and run your own self-hosted AI assistant. Open-source on GitHub with multi-channel support.
---
...
OpenClaw (also known as open claw) is fully open-source — browse the code, report issues, or contribute on [OpenClaw's GitHub repository](https://github.com/moltbot/moltbot). This guide covers installation, configuration, and connecting OpenClaw to New API.
